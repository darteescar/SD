...
public class ParallelNotificationTest {
     ...
     public static void main(String[] args) throws Exception {
          ...
          for (int i = 0; i < NUM_CLIENTES; i++) {
               ...
               threads[i] = new Thread(() -> {
                    try {
                         ...
                         studs[clienteId].sendNotificacaoVC(
                              TipoMsg.NOTIFICACAO_VC,
                              10
                         );

                         studs[clienteId].sendNotificacaoVS(
          ...
          System.out.println("[INFO] Todos os clientes terminaram de enviar eventos. Aguardando 15 segundos...");
          Thread.sleep(15000); // 15 segundos
          System.out.println("[INFO] 15 segundos passados, recolhendo respostas...");
